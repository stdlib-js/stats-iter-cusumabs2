...
```javascript
itercusumabs2 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-iter-cusumabs2@v0.2.3-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/stats-iter-cusumabs2/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/stats-iter-cusumabs2/actions/workflows/test.yml?query=branch:v0.2.3
